...
public class PlayerHeroAdapter extends ArrayAdapter<Player> {

    public PlayerHeroAdapter(Context context, List<Player> players) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            listItemView = LayoutInflater.from(getContext()).inflate(
                    R.layout.player_hero_list_item, parent, false);
        }

        Player players = getItem(position);

        ImageView heroAvatarImage = (ImageView) listItemView.findViewById(R.id.playerHeroAvatar);
        ...
        TextView playerNameView = listItemView.findViewById(R.id.playerPlayerNameText);
        TextView playerStatsView = listItemView.findViewById(R.id.playerStatsText);
        TextView playerGoldView = listItemView.findViewById(R.id.playerGoldText);
        TextView playerLastHitsView = listItemView.findViewById(R.id.playerLastHitsText);
        TextView playerLevelView = listItemView.findViewById(R.id.playerLevelText);
        ...
        playerStatsView.setText(kills + "/" + deaths + "/" + assists);
        playerGoldView.setText("Total Gold: " + totalGold);
        playerLastHitsView.setText("LH: " + lasthits);
        playerLevelView.setText("Lvl: " + level);

        RelativeLayout playerListItemHolderView = listItemView.findViewById(R.id.playerListItemHolder);
        boolean isPlayerRadiant = players.getIsRadiant();

        if (!isPlayerRadiant) {
            playerListItemHolderView.setBackgroundColor(Color.parseColor("#8F1716"));
        } else if (isPlayerRadiant) {
            playerListItemHolderView.setBackgroundColor(Color.parseColor("#434A28"));
        }
